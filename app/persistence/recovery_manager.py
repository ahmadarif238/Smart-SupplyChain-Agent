...
class RecoveryManager:
    ...
    def initiate_recovery(
        ...
        recovery_plan = {
            ...
            "decisions_to_retry": len(
                [d for d in checkpoint.decisions_made if d.get("status") == "pending"]
            ),
    ...
    def resume_from_checkpoint(self, db: Session, checkpoint_id: str) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            logger.info(
                f"Resuming from checkpoint {checkpoint_id} (cycle {checkpoint.cycle_number})"
            )
    ...
    def rollback_to_checkpoint(
        self, db: Session, checkpoint_id: str, reason: str = "manual_rollback"
    ) -> Dict[str, Any]:
        """
    ...
    def list_available_checkpoints(
        self, db: Session, goal: Optional[str] = None, limit: int = 20
    ) -> Dict[str, Any]:
    ...
    def analyze_failure_pattern(
        self, db: Session, goal: Optional[str] = None, lookback_cycles: int = 10
    ) -> Dict[str, Any]:
        """
        ...
        """
        try:
            checkpoints = self.memory_manager.get_checkpoint_history(
                db, goal, lookback_cycles
            )
            ...
            analysis = {
                ...
                "common_errors": [
                    ...
                    for err, count in common_errors[:10]
                ],
